...
# CSV FILE
csv_file=open('./pokemons/evolucion_chart.csv','w',newline='',encoding='utf-8')
csv_writter=csv.writer(csv_file)
csv_writter.writerow(['pokedex_id','pokedex_before','pokedex_after'])
...
for pokemon in pokemons:
  ...
  cells=pokemon.find('div',class_='infocard-list-evo')
  if cells:
    pokedex_number=cells[0].find('div',class_='infocard-list-evo').text
