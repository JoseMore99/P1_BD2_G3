...
# Leer el archivo CSV usando pandas
data = pd.read_csv('J:/universidad/bases 2/P1_BD2_G3/pokemons/pokemon_move_byegg.csv')
...
for i in range(len(pokedex_id)):
    ...
    collection.update_many(filtro, {"$addToSet": {"moves_byegg": {"move_name":move_name.iloc[i]}}})